...
const form = ref({
  ...
  startTime: format(new Date(props.event.startTime), "yyyy-MM-dd'T'HH:mm"),
  duration: props.event.duration,
  description: props.event.description,
  departments: [...(props.event.departments || [])],
  minRank: props.event.minRank || '',
  mandatory: props.event.mandatory || false,
  requiresApproval: props.event.requiresApproval || false
})
